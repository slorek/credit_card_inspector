...
Gem::Specification.new do |spec|
  ...
  spec.description   = %q{Credit Card Validator}
  spec.summary       = %q{Validates credit cards according to the Luhn algorithm. Also determines the type of card from its number}
  spec.homepage      = ""
  spec.license       = "MIT"
